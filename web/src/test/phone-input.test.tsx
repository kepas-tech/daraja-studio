...
describe('PhoneInput', () => {
  it('echoes the normalised number and flags junk', () => {
    ...
    fireEvent.change(screen.getByLabelText('Phone number'), { target: { value: '+254 700 123456' } });
    expect(onChange).toHaveBeenCalledWith('+254 700 123456');
    rerender(<PhoneInput label="Phone number" value="+254 700 123456" onChange={onChange} />);
