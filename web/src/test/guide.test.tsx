...
describe('How to use', () => {
  ...
  it('every step names a page that exists, so the manual cannot point at a route that is gone', () => {
    const routes = new Set([...copy.nav.map((e) => e.path), '/setup', '/login', '/send/phone', '/requests/:id', '/account', '/account/modules', '/people', '/go-live', '/businesses', '/accounts/:id', '/invoices/:id', '/reconcile']);
