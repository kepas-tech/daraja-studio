...
export function MoneyInput({ label, valueCents, onChange, wholeShillings, hint, error, autoFocus, labelHidden }: {
  label: string; valueCents: number | null; onChange: (cents: number | null) => void; wholeShillings?: boolean; hint?: string; error?: string; autoFocus?: boolean; labelHidden?: boolean;
}) {
  ...
  return (
    <TextField label={label} labelHidden={labelHidden} inputMode="decimal" value={text} autoFocus={autoFocus} autoComplete="off"
