...
export const copy = {
  ...
  ] as NavEntry[], { logout: 'Log out', menu: 'Menu', groups: { money: 'Money', manage: 'Manage', comingSoon: 'Planned' } }),
  ...
  setup: {
    ...
    intro: {
      owner: 'Your own login to this studio. Nobody else sees this password.',
      uses: 'Tick everything you need. You can change this later in Settings.',
      environment: 'Sandbox is Safaricom\'s practice area with pretend money. Production is your real M-Pesa account.',
      org: 'Shown in the header and on receipts, so people know whose studio this is.',
      shortcode: 'Your paybill or till number, as printed on your Safaricom letter.',
      daraja: 'The key and secret of your app on developer.safaricom.co.ke, under My Apps.',
      'public-url': 'Safaricom sends payment results to this address, so it must be reachable from the internet.',
      passkey: 'From the Daraja portal, under Lipa Na M-Pesa Online for this shortcode. We test it right away.',
      operator: 'The Safaricom portal user that is allowed to move money out of your account.',
