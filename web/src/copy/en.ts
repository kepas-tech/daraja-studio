...
export const copy = {
  ...
  request: {
    ...
    type: { b2c: 'Sent to a phone', c2b: 'Paid by a customer', stk: 'Asked a customer to pay', reversal: 'Reversal', balance: 'Balance check', status_query: 'Payment lookup' } as Record<string, string>,
