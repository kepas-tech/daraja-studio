...
export const copy = {
  ...
  businesses: {
    ...
    /** How many accounts one business holds, in the owner's words. */
    accounts: 'Accounts',
    ...
    noCustomers: 'No accounts yet.',
    addCustomer: 'Add an account',
    customerName: 'What is this account for?',
    customerNameHint: 'A name people will recognise: a clinic, a room, a tenant, a church.',
    ...
    accountsUnder: (name: string) => 'Sub-accounts under ' + name,
    noAccountsUnder: 'Nothing under this account yet.',
    addAccount: 'Add a sub-account',
    editAccount: 'Change',
    retire: 'Delete',
    ...
    pickCustomer: 'Pick a saved account',
