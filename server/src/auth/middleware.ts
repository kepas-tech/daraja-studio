...
declare global {
  ...
  namespace Express {
    interface Request {
      ...
      apiKey?: { keyId: string; name: string; prefix: string; role: import('../keys/service.js').KeyRole; permissions: import('../permissions/catalog.js').PermissionKey[]; businessId: string | null };
