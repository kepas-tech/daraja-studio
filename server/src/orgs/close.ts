...
export const CLOSED_CHILD_TABLES = [
  'sessions', 'permissions', 'callbacks_raw', 'balances', 'requests', 'bulk_plans', 'customer_invoices', 'contacts', 'number_history', 'accounts', 'businesses', 'operators', 'settings', 'people',
] as const;
