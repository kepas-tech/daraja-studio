# Daraja Studio roadmap

Where the menu stands and what is next: [MENU-PLAN.md](MENU-PLAN.md). It is the single source of
truth — read it first. This file is a short index alongside it.
...
approval, Bulk send, Contacts, Businesses, Invoices, Standing orders, Express checkout,
Bonga points. Also shipped: Export as a spreadsheet on History and Invoices (0.19.0).
